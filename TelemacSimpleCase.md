...
```
TITLE = 'test'
GEOMETRY FILE = test.slf
INITIAL CONDITIONS = 'CONSTANT DEPTH'
INITIAL DEPTH = 0.01
BOUNDARY CONDITIONS FILE = test.cli
LIQUID BOUNDARIES FILE = test.qsl
...
RESULTS FILE = test-result.slf
MASS-BALANCE = YES
VARIABLES FOR GRAPHIC PRINTOUTS = 'U,V,H,S,I,J'
